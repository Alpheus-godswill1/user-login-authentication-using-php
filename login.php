    ...
    <div class="leading-loose">
      <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" action="./function.php" method="POST">
        ...
        <div class="">
          ...
          <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="username" name="cus_name" type="text" required="" placeholder="User Name" aria-label="username">
        </div>
        <div class="mt-2">
          <label class="block text-sm text-gray-600" for="password">Password</label>
          <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="password" name="cus_pass" type="password" required="" placeholder="*******" aria-label="password">
        </div>
